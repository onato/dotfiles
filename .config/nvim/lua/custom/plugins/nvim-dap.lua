  ...
  config = function()
    ...
    dap.adapters.codelldb = {
      ...
      executable = {
        ...
        command = os.getenv("HOME") .. "/bin/codelldb-aarch64-darwin/extension/adapter/codelldb",
        args = {
          "--port",
          "13000",
          "--liblldb",
    ...
    vim.keymap.set("n", "<leader>ds", dap.step_over, { desc = "Debug [s]tep over" })
    ...
    vim.keymap.set("n", "<leader>db", dap.toggle_breakpoint, { desc = "Debug set [b]reakpoint" })
